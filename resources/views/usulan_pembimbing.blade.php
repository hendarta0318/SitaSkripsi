...
<div class="">
    ...
    <div class="mb-3 row">
        <label for="formFile" class="col-sm-2 col-form-label">Draf Proposal *</label>
        <div class="col-sm-10">
    ...
    <div class="mb-3 row">
        <label for="formFile" class="col-sm-2 col-form-label">KRS Berjakan *</label>
        <div class="col-sm-10">
            <input class="form-control" type="file" id="formFile">
            <div id="fileHelp" class="form-text">*Format PDF, ukuran maksimal 2MB.</div>
        </div>
     ...
     <div class="mb-3 row">
        <label for="formFile" class="col-sm-2 col-form-label">Form Persetujuan Calon Dosen Pembimbing *</label>
        <div class="col-sm-10">
            <input class="form-control" type="file" id="formFile">
            <div id="fileHelp" class="form-text">*Format PDF, ukuran maksimal 2MB.</div>
        </div>
